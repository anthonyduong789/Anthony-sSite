    ...
    >
      <div className="color-black">
        <div
          ...
          className="container mx-auto flex md:px-20 md:py-10 lg:flex-row flex-col items-center "
        >
          <div className="lg:flex-grow mt-5 md:mt-0   md: w-1.5/2 lg: md:pr-4 flex flex-col md:items-start md:text-left mb-16 lg:mb-0 items-center text-center lg:w-1/2">
            <h1
            ...
            <p
              className="mb-8 md:pl-0  pl-2 pr-2 leading-relaxed text-lg md:text-base text-gray-700 dark:text-gray-400 lg:text-xl"
              data-aos="fade-up"
              data-aos-delay="350"
            >
            ...
            <div className="flex justify-center">
              <div
                className="inline-flex text-white bg-emerald-600 border-0 py-2 px-4 lg:px-6 focus:outline-none hover:bg-emerald-600 rounded text-lg cursor-pointer"
                data-aos="flip-up"
                data-aos-delay="500"
              ...
              <div
                className="ml-4 inline-flex text-black border-0 py-2 px-6 focus:outline-none bg-blue-500 hover:bg-blue-400 focus:ring-blue-300 rounded text-lg cursor-pointer"
                data-aos="flip-down"
                data-aos-delay="800"
          ...
          <div className="lg:max-w-md lg:w-full mb-5 md:mb-0 md:w-1/2 w-4/6">
            <img
